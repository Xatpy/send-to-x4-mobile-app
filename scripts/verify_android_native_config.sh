...
check_contains "$ROOT_DIR/android/build.gradle" 'compileSdkVersion\s*=\s*35' 'compileSdkVersion pinned to 35'
check_contains "$ROOT_DIR/android/build.gradle" 'targetSdkVersion\s*=\s*35' 'targetSdkVersion pinned to 35'
...
check_contains "$ROOT_DIR/app.json" '"compileSdkVersion"\s*:\s*35' 'compileSdkVersion pinned in app.json plugin config'
check_contains "$ROOT_DIR/app.json" '"targetSdkVersion"\s*:\s*35' 'targetSdkVersion pinned in app.json plugin config'
